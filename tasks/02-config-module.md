...
## Steps
1. Create `src/config.ts` with Zod schema defining: processor (claude|gemini|codex), batchSize, processingTimeout, bookmarksPlist path, outputDir, statePath, reportsDir, logLevel
